	...
	<form method="POST" class="form bg-white rounded-md shadow p-6 w-full" use:enhance={submitForm}>
		<div class="input-field input-field flex items-center gap-2">
			<label class="label">
				...
				<input required name="name" class="input" placeholder="name of this staff" />
			</label>
		</div>
		<div class="input-field input-field flex items-center gap-2">
			<label class="label">
				<span>Staff Position </span>
				<input required name="position" class="input" placeholder="name of this staff" />
			</label>
		</div>
		<div class="input-field input-field flex items-center gap-2">
			<label class="label">
				<span>Staff Department </span>
				<input required name="department" class="input" placeholder="name of this staff" />
			</label>
		</div>
		<div class="input-field input-field flex items-center gap-2">
			<label class="label">
				<span>Staff Gender</span>
				<select name="gender" class="input py-2">
		...
		<div class="input-field flex items-center gap-2">
			<label class="label">
				...
				<input required name="address" class="input" placeholder="address of this staff" />
			</label>
		</div>
		<div class="input-field flex items-center gap-2">
			<label class="label">
				<span>Staff Region</span>
				<select required name="region" class="input py-2">
