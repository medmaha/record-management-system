...
<div class="max-w-[500px] mx-auto pt-16 form-wrapper">
	<form method="POST" class="bg-white rounded-md shadow p-6 w-full" use:enhance={submitForm}>
		<div class="flex items-center gap-2">
			<label id="name">
				<span>Company Name </span>
				<input id="name" name="name" class="input" placeholder="name of this company" />
			</label>
		</div>
		<div class="flex items-center gap-2">
			<label id="city">
				<span> Headquarter </span>
				<input id="headquarter" name="city" class="input" placeholder="branch city name" />
			</label>
		</div>
		<div class="flex items-center gap-2">
			<label id="region">
		...
		<div class="flex items-center gap-2">
			<label id="phone_number">
				...
				<input
					...
					name="phone_number"
					class="input"
					placeholder="branch city region"
				/>
			</label>
		</div>
